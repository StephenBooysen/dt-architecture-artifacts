/**
 * @fileoverview Metadata parsing utilities for markdown files.
 * 
 ...
 */
export function getCleanMarkdownContentWithoutMetadata(markdownContent) {
  if (!markdownContent || typeof markdownContent !== 'string') {
 ...
 */
export function injectMetadata(cleanMarkdownContent, metadata) {
 ...
 */
export function addRecentEdit(metadata, username, timestamp = null) {
  if (!metadata || typeof metadata !== 'object') {
 ...
 */
export function toggleStarred(metadata, starred = null) {
  if (!metadata || typeof metadata !== 'object') {
    metadata = createDefaultMetadata();
  }
 ...
 */
export function getRecentEditsWithinDays(metadata, days = 7) {
 ...
 */
export function hasRecentEdits(metadata, days = 7) {
 ...
 */
export function getMostRecentEdit(metadata) {
 ...
 */
export function cleanupOldEdits(metadata) {
  if (!metadata || !Array.isArray(metadata.recentEdits)) {
    return metadata;
  }
