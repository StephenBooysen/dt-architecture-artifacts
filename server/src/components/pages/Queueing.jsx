    ...
    <>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.getElementById('openApiDocsBtn').addEventListener('click', function() {
          const apiDocsUrl = '/api/queueing/docs';
          ...
          if (popup) {
            ...
            showToast('Please allow popups for this site and try again, or visit /api/queueing/docs directly.', true);
          }
        });
