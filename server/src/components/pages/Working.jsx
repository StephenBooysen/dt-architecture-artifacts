    ...
    <>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.getElementById('openApiDocsBtn').addEventListener('click', function() {
          const apiDocsUrl = '/api/working/docs';
          ...
          if (popup) {
            ...
            showToast('Please allow popups for this site and try again, or visit /api/working/docs directly.', 'error');
          }
        });
