    ...
    <>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.getElementById('openApiDocsBtn').addEventListener('click', function() {
          const apiDocsUrl = '/api/filing/docs';
          ...
          if (popup) {
            ...
            showToast('Please allow popups for this site and try again, or visit /api/filing/docs directly.', 'error');
          }
        });
