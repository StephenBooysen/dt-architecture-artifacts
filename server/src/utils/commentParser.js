/**
 * @fileoverview Server-side comment parsing utilities for markdown files.
 * 
 ...
 */
function extractComments(markdownContent) {
 ...
 */
function getCleanMarkdownContent(markdownContent) {
  if (!markdownContent || typeof markdownContent !== 'string') {
 ...
 */
function injectComments(cleanMarkdownContent, comments) {
 ...
 */
function removeComment(existingComments, commentId) {
  if (!Array.isArray(existingComments)) {
    return [];
  }
 ...
 */
function updateComment(existingComments, commentId, updates) {
  if (!Array.isArray(existingComments)) {
    return [];
  }
