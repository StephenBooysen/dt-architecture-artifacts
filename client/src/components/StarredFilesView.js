...
const StarredFilesView = ({ onFileSelect, isVisible }) => {
  ...
  if (isLoading) {
    return (
      <div className="starred-files-view p-4">
      ...
      {starredFiles.length === 0 && !error ? (
        ...
        <div className="starred-files-list">
          {starredFiles.map((file, index) => (
            <div
              key={file.path}
              className="starred-file-item p-3 mb-2 border rounded cursor-pointer"
                ...
                <div className="flex-grow-1">
                  ...
                  <div className="d-flex align-items-center gap-3 small">
                    <span className="text-muted">
                      ...
                      Starred {formatDate(file.starredAt)} at {formatTime(file.starredAt)}
                    </span>
